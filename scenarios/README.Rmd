...
plot(
  effects$`bus_stops_per_1000:cats__`$bus_stops_per_1000,
  effects$`bus_stops_per_1000:cats__`$cond__
)
```
...
As with any model, the usefulness of the outputs rely on the quality of the inputs and the assumptions underlying the model, which we will cover in next section.
The 
