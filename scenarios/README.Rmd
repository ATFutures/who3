...
accra_pt = accra %>% mutate(bus_stops_per_1000 = 10)
...
Under this scenario, the central estimate of car use drops by 12 percentage point while the central estimates for walking and cycling grow, by 2 percentage points and 4 percentage points, respectively.
