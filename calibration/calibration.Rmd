...
Figure 1, and was typical for most layers, manifesting a clear and distinctive
minimum at 600m.
...
statistically summarised in Table 1, in which the .
...
knitr::kable (coeffs, digits = c (NA, 0, 0, 2, 4), caption = "Table 1. Statistical parameters of final model of pedestrian flows through New York City. (Placeholder only in rendered version)")
```
